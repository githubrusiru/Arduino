...
// BUTTON
#define NUM_BUTTON          2 // Reduced since we're only sending SMS
#define SEND_BUTTON_PIN     8
#define NO_PRESS           -1
#define SEND_BUT            0

short gsArray_But_Pin[NUM_BUTTON] = {SEND_BUTTON_PIN}; // Adjusted for two buttons
...
// Timing constants
const unsigned long START_DELAY = 2500; // 2 seconds (2000 ms)
